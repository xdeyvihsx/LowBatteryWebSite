      ...
      <div className="bg-none bg-no-repeat bg-cover box-border caret-transparent justify-center bg-center m-auto md:bg-[url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVQYV2NgYAAAAAMAAWgmWQ0AAAAASUVORK5CYII=)]">
        ...
        >
          <input
            type="hidden"
            name="_clientID"
            defaultValue="100025126"
            className="appearance-none bg-transparent box-border caret-transparent hidden basis-[0%] grow-[3] p-0 md:basis-auto md:grow-0"
          />
          <input
            type="hidden"
            name="_deExternalKey"
            defaultValue="RiotAccountData"
            className="appearance-none bg-transparent box-border caret-transparent hidden basis-[0%] grow-[3] p-0 md:basis-auto md:grow-0"
          />
          <input
            type="hidden"
          ...
          <input
            type="hidden"
            name="_successURL"
            defaultValue="https://www.ruinedking.com/es-es/#Newsletter"
            className="appearance-none bg-transparent box-border caret-transparent hidden basis-[0%] grow-[3] p-0 md:basis-auto md:grow-0"
          />
          <input
            type="hidden"
            name="_errorURL"
            defaultValue="https://www.ruinedking.com/es-es/"
            className="appearance-none bg-transparent box-border caret-transparent hidden basis-[0%] grow-[3] p-0 md:basis-auto md:grow-0"
          />
          <input
            type="hidden"
          ...
          <input
            type="hidden"
            name="riot forge publication list"
            defaultValue="true"
            className="appearance-none bg-transparent box-border caret-transparent hidden basis-[0%] grow-[3] p-0 md:basis-auto md:grow-0"
          />
          <input
          ...
          <div className="relative box-border caret-transparent basis-full grow shrink-0 min-h-[auto] min-w-[auto] mb-2.5 md:basis-[0%] md:grow-[2] md:shrink">
            <div className="box-border caret-transparent">
              ...
              />
              <div className="relative box-border caret-transparent z-[2] m-auto left-0 top-full md:absolute">
                <div className="text-white items-center box-border caret-transparent flex tracking-[-0.16px] text-left m-auto pt-0 md:pt-2.5"></div>
              </div>
            </div>
          </div>
          <div className="relative box-border caret-transparent basis-full grow shrink-0 min-h-[auto] min-w-[auto] mb-2.5 md:basis-[0%] md:grow-[2] md:shrink">
